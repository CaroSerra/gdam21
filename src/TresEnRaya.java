 ...
 * @version 1.1
 * 
 *          Curso 2021 - 2022 Entornos de Desarrollo (GDAM)
 *
 */
public class TresEnRaya {
	 ...
	 * 
	 * @see <a href=
	 *      "https://javadoc.io/doc/org.fusesource.jansi/jansi/latest/index.html">Jansi
	 *      2.4.0</a>
	 */
	Ansi scr;
	...
	/**
	 * Contructor Crea un tablero vacío
	 * 
	 * texto en negrita!
	 */
	public TresEnRaya() {
 ...
 */
	...
	/**
	 * limpiarTablero: Inicializa el tablero, eliminando cualquier ficha existente
	 * 
	 * @author lone
	 */
	...
	/**
	 * muestraTablero: Pinta el tablero con el estado actual de la partida
	 * 
	 * @author lone
	 */
	...
	/**
	 * Solicita la posición de la ficha y la coloca en el tablero. No está
	 * implementada la comprobación de posición válida de la ficha. <br>
	 * Utiliza {@link TresEnRaya#marcarCelda}
	 * 
...
/**
 * 
 * @param fila SE COMPRUEBA
 * @param columna SE COMPRUEBA
 * @return true
 */
